'''
solution2: 각 행마다 4 * 3 = 12 번씩 총 12,000,000 회 탐색
| 1 | 2 | 3 | 5 |
| 5 | 6 | 7 | 8 | =>       / 1 + 6 / 1 + 7 / 1 + 8
                     2 + 5 /       / 2 + 7 / 2 + 8
                     3 + 5 / 3 + 6         / 3 + 8
...
solution1: 최대값과 prev(flag 개념) 을 이용해서 3 + 3 = 6 번씩 총 6,000,000 회 탐색
| 1 | 2 | 3 | 5 | => max = 5, prev = land[0].index(5) = 3, dk(idx) = 0, 1, 2
